...
public class TestProtocol {
  ...
  public void testSplitProtocolBuild() {
    ...
    Protocol parsedStringProtocol = io.yoyolabs.org.apache.avro.Protocol.parse(protocolString);
    Protocol parsedArrayOfStringProtocol =
      io.yoyolabs.org.apache.avro.Protocol.parse(protocolString.substring(0, mid),
                                     protocolString.substring(mid));
