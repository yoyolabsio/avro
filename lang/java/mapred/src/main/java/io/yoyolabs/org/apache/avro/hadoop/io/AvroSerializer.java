...
import io.yoyolabs.org.apache.avro.mapred.AvroWrapper;
import io.yoyolabs.org.apache.avro.reflect.ReflectDatumWriter;
 ...
 * io.yoyolabs.org.apache.avro.mapred.AvroWrapper} objects and serialization is handled by this
 * class.</p>
 *
 ...
 * io.yoyolabs.org.apache.avro.mapreduce.AvroJob} to help with Job configuration.</p>
 *
...
public class AvroSerializer<T> implements Serializer<AvroWrapper<T>> {
   ...
   *
   * This number was copied from the AvroSerialization of io.yoyolabs.org.apache.avro.mapred in Avro 1.5.1.
   *
