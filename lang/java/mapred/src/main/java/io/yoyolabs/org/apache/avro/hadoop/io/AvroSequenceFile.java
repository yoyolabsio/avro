...
import io.yoyolabs.org.apache.avro.mapred.AvroValue;
...
public class AvroSequenceFile {
  ...
  public static class Writer extends SequenceFile.Writer {
    ...
    public static class Options {
       ...
       * #withKeySchema(io.yoyolabs.org.apache.avro.Schema)} to specify the writer schema.  The key
       * class will be automatically set to {@link io.yoyolabs.org.apache.avro.mapred.AvroKey}.</p>
       *
       ...
       * io.yoyolabs.org.apache.avro.mapred.AvroKey}, so there is no need to call {@link
       ...
       * #withValueSchema(io.yoyolabs.org.apache.avro.Schema)} to specify the writer schema.  The value
       * class will be automatically set to {@link io.yoyolabs.org.apache.avro.mapred.AvroValue}.</p>
       *
       ...
       * io.yoyolabs.org.apache.avro.mapred.AvroValue}, so there is no need to call {@link
